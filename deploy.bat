@echo off
echo 🚀 Easy Calorie Guide - Deployment Script
...
REM Step 2: Update Frontend Environment
echo.
echo 🔧 Step 2: Updating frontend environment...
cd ..

REM Update .env.local with the backend URL
...
set /p FRONTEND_URL="Enter your frontend URL (e.g., https://your-frontend.vercel.app): "

REM Step 3: Update Backend CORS
echo.
echo 🔧 Step 3: Updating backend CORS settings...
cd server

echo Setting FRONTEND_URL environment variable...
echo Please run: vercel env add FRONTEND_URL production
